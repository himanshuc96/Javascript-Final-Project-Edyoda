...
//Homepage Section
// api url
const productListURL = "https://5d76bf96515d1a0014085cf9.mockapi.io/product";
...
function show(data) {
  data.forEach(function (product) {
    ...
    if (product.isAccessory) {
      document.getElementById("accessories").appendChild(card);
    } else {
      document.getElementById("clothes").appendChild(card);
    }
  });
}
